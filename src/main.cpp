...
#if defined(NDEBUG)
# error "Minecoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Minecoin Signed Message:\n";
...
void ThreadScriptCheck() {
    RenameThread("minecoin-scriptch");
...
bool ContextualCheckBlockHeader(const CBlockHeader& block, CValidationState& state, CBlockIndex * const pindexPrev)
{
    ...
    // Minecoin: Reject block.nVersion=1 blocks (mainnet >= 710000, testnet >= 400000, regtest uses supermajority)
    ...
    if (block.nVersion < 3 && CBlockIndex::IsSuperMajority(3, pindexPrev, Params().RejectBlockOutdatedMajority()) && nHeight >= 750000)
    {
    ...
    if (block.nVersion < 4 && CBlockIndex::IsSuperMajority(4, pindexPrev, Params().RejectBlockOutdatedMajority()) && nHeight >= 800000)
...
bool ContextualCheckBlock(const CBlock& block, CValidationState& state, CBlockIndex * const pindexPrev)
{
    ...
    // Minecoin: (mainnet >= 710000, testnet >= 400000, regtest uses supermajority)
