...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Minecoin Core minecoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  minecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded minecoin transaction") + "\n" +
              "  minecoin-tx [options] -create [commands]   " + _("Create hex-encoded minecoin transaction") + "\n" +
              "\n";
